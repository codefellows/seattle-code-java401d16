...
public class SuperPetRecyclerViewAdapter extends RecyclerView.Adapter<SuperPetRecyclerViewAdapter.SuperPetViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SuperPetViewHolder holder, int position) {
        ...
        TextView superPetFragTypeView = holder.itemView.findViewById(R.id.SuperPetFragTVType);
        String superPetName = superPetList.get(position).getName();
        String superPetType = superPetList.get(position).getType();
        superPetFragNameView.setText(position + ". " + superPetName);
        superPetFragTypeView.setText(superPetType);
        ...
        superPetViewHolder.setOnClickListener(v -> {
            ...
            goToSuperPetDetailsIntent.putExtra(SUPER_PET_NAME_TAG, superPetName);
            goToSuperPetDetailsIntent.putExtra(SUPER_PET_TYPE_TAG, superPetType);
