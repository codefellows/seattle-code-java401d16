...
public final class SuperPet implements Model {
  ...
  private SuperPet(String id, String name, SuperPetTypeEnum type, Integer height) {
    this.id = id;
    this.name = name;
    this.type = type;
    this.height = height;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, SuperPetTypeEnum type, Integer height) {
      super.id(id);
      super.name(name)
        .type(type)
        .height(height);
